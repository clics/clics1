...
\address{ 
               $^{1}$Philipps-Universit\"at Marburg, $^{2}$Heinrich-Heine-Universit\"at D\"usseldorf, $^{3}$Universiteit Leiden \\
               %$^{1}$Deutschhausstra{\ss}e 3, 35037 Marburg, $^{2}$Universit\"atsstra{\ss}e 1, 40225 D\"usseldorf, $^{3}$P.N. van Eyckhof 2, 2311 BV Leiden \\
	       \href{mailto:thomas.mayer@uni-marburg.de}{thomas.mayer@uni-marburg.de}, 
	       \href{mailto:mattis.list@uni-marburg.de}{mattis.list@uni-marburg.de}, \\
	       \href{mailto:terhalle@phil.uni-duesseldorf.de}{terhalle@phil.uni-duesseldorf.de}, 
	       \href{mailto:m.urban@hum.leidenuniv.nl}{m.urban@hum.leidenuniv.nl}\\}
...
crosslinguistic colexifications. The network is represented as a force-directed graph and features a
number of interactive components that allow the user to get an overview of the overall structure
while at the same time providing an opportunity to look into the data in more detail. An integral
...
\\ \newline \Keywords{interactive visualization, colexification, crosslinguistic database}}
