...
\name{Thomas Mayer$^{1}$, Johann-Mattis List$^{1}$, Anselm Terhalle$^{2}$, Matthias Urban$^{3}$}

\address{ 
               $^{1}$Philipps University of Marburg, $^{2}$Heinrich-Heine University of D\"usseldorf, $^{3}$Universiteit Leiden \\
               %$^{1}$Deutschhausstra{\ss}e 3, 35037 Marburg, $^{2}$Universit\"atsstra{\ss}e 1, 40225 D\"usseldorf, $^{3}$P.N. van Eyckhof 2, 2311 BV Leiden \\
	       \url{thomas.mayer@uni-marburg.de}, 
	       \url{mattis.list@uni-marburg.de}, \\
	       \url{terhalle@phil.uni-duesseldorf.de}, 
	       \url{m.urban@hum.leidenuniv.nl}\\}
...
\newcommand{\clics}[1]{http://clics.lingpy.org/#1}
