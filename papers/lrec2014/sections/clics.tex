...
sources themselves. Table \ref{tab:clics} gives an example of the basic structure of the data in CLICS.
...
in advance.
Here, we use the term \textit{colexification} (originally from \beautiful{francois2008}) %\nocite{francois2008}
...
the languages. For instance, %we would say that 
%Wayuu [guc] colexifies `good' and `beautiful' by means of the word form \textit{anas\textbari}.
...
\subsection{CLICS' data and sources}
...
\beautiful{Key2007}), offering lexical data for 233 languages and language varieties.
...
in CLICS. (2) The \emph{World Loanword Database} (WOLD, \beautiful{Wold2009}), the main goal
