...
expressed by the same word form in more than on language family are shaded gray.}
\label{tab:clics}
\end{table}
...
in advance.
Here, we use the term colexification (originally from Fran\c{c}ois 2008)
\nocite{francois2008}
...
the languages. For instance, we would say that Wayuu [guc] colexifies ``good'' and ``beautiful'' by means of the word form \textit{anas\textbari}.
