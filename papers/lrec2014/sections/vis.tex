...
\begin{figure*}[htbp]
\begin{center}
    \href{\clics{browse.php?gloss=money&view=part}}{\includegraphics[width=\textwidth]{img/silvermoneyAREAL.pdf}}
...
\begin{figure}[h]
   ...
   \includegraphics[width=0.48\textwidth]{img/Lab_HSV2.png}
    \caption{Comparison between two-dimensional color gradients in the L*a*b* (left) and HSV (right) color space}
    \label{lab vs hsv}
\end{figure}
...
\begin{figure*}[htbp]
\begin{center}
    \href{\clics{browse.php?gloss=wheel&view=part}}{\includegraphics[width=\textwidth]{img/footwheelAREAL.pdf}}
