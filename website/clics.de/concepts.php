...
<div id="wrapper">
 ...
 <div id="subnav">
   ...
   <ul>
    ...
    <li><a class="active" href="concepts.php">Concepts</a></li>
  </ul>
<br>
 ...
 <div id="contentwrapper" class="clearfix">
    ...
    <div id="btf">
	 ...
	 <!-- SIDEBAR about -->
<h3>Concepts used in CLICS</h3>
<br>
<iframe style="border 2px solid white;" src="tables/concepts.html" width="100%" height="500px"></iframe>
